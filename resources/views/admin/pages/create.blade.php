                ...
                <div class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-panel space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3"
                                  ...
                                  class="mt-1.5 w-full rounded-2xl border-warm-300/50 bg-warm-100 px-4 py-2.5 text-sm text-brand-ink shadow-sm transition focus:border-brand-primary focus:ring-brand-primary">{{ old('meta_description') }}</textarea>
