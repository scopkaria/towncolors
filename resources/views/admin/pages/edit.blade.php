<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.pages.index') }}" class="flex h-9 w-9 items-center justify-center rounded-xl border border-warm-300/50 bg-warm-100 text-brand-muted shadow-sm transition hover:border-brand-primary hover:text-brand-primary">
            ...
            <div class="space-y-1">
                <span class="inline-flex rounded-full border border-accent/30 bg-accent-light px-3 py-0.5 text-[11px] font-semibold uppercase tracking-[0.32em] text-brand-primary">CMS</span>
            ...
            <div class="lg:col-span-2 space-y-5">
                ...
                <div class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-panel space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex items-center rounded-2xl border border-warm-300/50 bg-warm-100 shadow-sm transition focus-within:border-brand-primary focus-within:ring-1 focus-within:ring-brand-primary">
                            <span class="select-none border-r border-warm-300/50 px-3 py-3 text-sm text-brand-muted">/page/</span>
                ...
                <div class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-panel">
                    ...
                    <div class="mt-4">
                        <div id="editor"
                             class="rounded-2xl border border-warm-300/50 bg-warm-100 text-sm text-brand-ink"
                ...
                <div class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-panel">
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        ...
                        <label class="relative inline-flex cursor-pointer items-center">
                            ...
                            <div class="peer h-6 w-11 rounded-full bg-warm-300 transition after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:bg-warm-100 after:shadow-sm after:transition peer-checked:bg-brand-primary peer-checked:after:translate-x-full"></div>
                        </label>
                    </div>
                    ...
                    <div class="mt-4 border-t border-warm-300/40 pt-4">
                ...
                <div class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-panel space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title"
                               ...
                               class="mt-1.5 w-full rounded-2xl border-warm-300/50 bg-warm-100 px-4 py-2.5 text-sm text-brand-ink shadow-sm transition focus:border-brand-primary focus:ring-brand-primary">
                        @error('meta_title')
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3"
                                  class="mt-1.5 w-full rounded-2xl border-warm-300/50 bg-warm-100 px-4 py-2.5 text-sm text-brand-ink shadow-sm transition focus:border-brand-primary focus:ring-brand-primary">{{ old('meta_description', $page->meta_description) }}</textarea>
