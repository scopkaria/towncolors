                ...
                <div class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-panel">
                    ...
                    <div class="mt-4">
                        <label for="featured_image"
                               class="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-stone-200 bg-stone-50 py-10 transition hover:border-brand-primary hover:bg-orange-50/30"
                               id="image-drop-label">
            ...
            <div class="space-y-5">
                ...
                <div class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-panel space-y-4">
                    ...
                    <div class="rounded-2xl bg-stone-50 px-4 py-3">
                        ...
                        <p class="mt-0.5 text-xs text-green-700" id="seo-url-preview">{{ url('/blog/') }}/</p>
