                        ...
                        <tr class="group transition hover:bg-stone-50/60">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    @else
                                        <div class="flex h-10 w-14 flex-shrink-0 items-center justify-center rounded-lg bg-stone-100">
                                    ...
                                    @endif
                                    <div>
                                        <p class="font-semibold text-brand-ink">{{ $post->title }}</p>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('admin.posts.edit', $post) }}"
                                   class="inline-flex items-center gap-1.5 rounded-xl border border-stone-200 bg-white px-3 py-1.5 text-xs font-semibold text-brand-muted shadow-sm transition hover:border-brand-primary hover:text-brand-primary">
