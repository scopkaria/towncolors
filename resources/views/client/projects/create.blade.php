        ...
        <form method="POST" action="{{ route('client.projects.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-panel space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-3 rounded-2xl border-2 border-dashed border-stone-200 bg-stone-50/50 px-6 py-8 text-center transition duration-200 hover:border-brand-primary hover:bg-orange-50/30">
