<x-public-layout title="Contact Us">
    ...
    @php($heroSettings = \App\Models\Setting::first())

    <x-public-hero
        badge="Get In Touch"
        title="Contact Us"
        :subtitle="$heroSettings?->heroSubtitle('contact') ?: 'Let\'s discuss your project and bring your ideas to life.'"
        :media="$heroSettings?->heroMediaUrl('contact')"
    />
    ...
    <section class="bg-brand-surface py-16 sm:py-24">
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            {{-- Success banner --}}
            @if(session('success'))
            <div class="mb-10 flex items-start gap-3 rounded-xl border border-green-200 bg-green-50 p-5 reveal dark:border-green-700 dark:bg-green-900/30">
                <svg class="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600 dark:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="grid gap-12 lg:grid-cols-5 lg:gap-16">
                ...
                <div class="lg:col-span-3 reveal">
                    <div class="card-premium rounded-2xl bg-warm-100 p-8 shadow-lg dark:bg-slate-800/90 dark:shadow-slate-900/50 sm:p-10">
                        ...
                        <form action="{{ route('contact.store') }}" method="POST" class="mt-8 space-y-6" novalidate>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="mt-1.5 block w-full rounded-xl border px-4 py-3 text-sm text-brand-ink placeholder-brand-muted/60 shadow-sm transition
                                           ...
                                           @error('name') border-red-400 bg-red-50 dark:border-red-500 dark:bg-red-900/20 @else border-gray-200 bg-gray-50 dark:border-slate-600 dark:bg-slate-700/50 @enderror"
                                >
                                @error('name')
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="mt-1.5 block w-full rounded-xl border px-4 py-3 text-sm text-brand-ink placeholder-brand-muted/60 shadow-sm transition
                                           focus:outline-none focus:ring-2 focus:ring-brand-primary/40
                                           @error('email') border-red-400 bg-red-50 dark:border-red-500 dark:bg-red-900/20 @else border-gray-200 bg-gray-50 dark:border-slate-600 dark:bg-slate-700/50 @enderror"
                                >
                                @error('email')
                                <p class="mt-1.5 flex items-center gap-1 text-xs text-red-600">
                                    <svg class="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    class="mt-1.5 block w-full resize-none rounded-xl border px-4 py-3 text-sm text-brand-ink placeholder-brand-muted/60 shadow-sm transition
                                           focus:outline-none focus:ring-2 focus:ring-brand-primary/40
                                           @error('message') border-red-400 bg-red-50 dark:border-red-500 dark:bg-red-900/20 @else border-gray-200 bg-gray-50 dark:border-slate-600 dark:bg-slate-700/50 @enderror"
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="tel:{{ $settings->phone }}"
                               class="group flex items-start gap-4 rounded-2xl border border-gray-200 bg-warm-100 p-5 shadow-sm transition hover:border-brand-primary/40 hover:shadow-md dark:border-slate-600/50 dark:bg-slate-800/80">
                            ...
                            @if($settings->address)
                            <div class="flex items-start gap-4 rounded-2xl border border-gray-200 bg-warm-100 p-5 shadow-sm dark:border-slate-600/50 dark:bg-slate-800/80">
                        ...
                        <div class="rounded-2xl border border-warm-300/50 bg-warm-100 p-5 dark:border-slate-600/50 dark:bg-slate-800/80">
                            <p class="text-xs font-bold uppercase tracking-widest text-brand-primary">Business Message</p>
                            <p class="mt-2 text-sm leading-7 text-brand-muted">
                                We are ready to help you build, grow, and succeed.
                            </p>
                        </div>
    ...
    {{-- ===================== CTA STRIP ===================== --}}
    <section class="bg-warm-200/50 border-t border-warm-300/40 py-14 sm:py-20 dark:border-slate-700/40 dark:bg-navy-900/60">
