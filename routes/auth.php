...
Route::middleware('guest')->group(function () {
    Route::get('register', [RegisteredUserController::class, 'choose'])
                ->name('register');
    ...
    Route::get('register/freelancer', [RegisteredUserController::class, 'createFreelancer'])
    ...
    Route::get('login/client', [AuthenticatedSessionController::class, 'createClient'])
                ->name('login.client');
    Route::post('login/client', [AuthenticatedSessionController::class, 'store'])
                ->name('login.client.post');

    Route::get('login/freelancer', [AuthenticatedSessionController::class, 'createFreelancer'])
                ->name('login.freelancer');
    Route::post('login/freelancer', [AuthenticatedSessionController::class, 'store'])
                ->name('login.freelancer.post');
